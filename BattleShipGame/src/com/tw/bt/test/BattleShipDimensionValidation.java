 ...
 *
 */
public class BattleShipDimensionValidation {
	...
	public void init(){
		try{
			...
			this.scanner= new Scanner(AllTests.class.getClassLoader().getResource("resource/BettleShipDimensionValidation.txt").openStream());
