 ...
 *
 */
public class BattleShipLocationValidation {
	...
	public void init(){
		try{
			...
			this.scanner= new Scanner(AllTests.class.getClassLoader().getResource("resource/BattleShipLocationValidation.txt").openStream());
	...
	@Test(expected=InvalidLocationOfBattleShipException.class)
	public void test() {
		this.input.init();
		this.input.getInput();
	}
